...
const HomePage = () => {
  return (
    <div className="container px-6 py-16 mx-auto">
            ...
            <div className="w-full space-y-12 lg:w-1/2 ">
              <div>
                <h1 className="text-3xl font-semibold text-gray-800 capitalize lg:text-4xl dark:text-white">
                  explore our <br /> awesome website
                </h1>
      ...
      <section className="bg-white dark:bg-gray-900 w-[100%] mb-32">
        <div className="container px-6 py-10 mx-auto w-full">
          <h1 className="text-3xl font-semibold text-center text-gray-800 capitalize lg:text-4xl dark:text-white">
            Our <span className="text-blue-500">Users Review</span>
          </h1>

          <p className="max-w-2xl mx-auto my-6 text-center text-gray-500 dark:text-gray-300">
            E-connect is platform which provide wide range of people access to
            Interact with a large community here are some Users review
          </p>
          ...
          <div className="grid grid-cols-1 gap-8 mt-8 xl:mt-16 md:grid-cols-2 xl:grid-cols-2">
            <div className="px-12 py-8 transition-colors duration-200 transform border cursor-pointer rounded-xl hover:border-transparent group hover:bg-blue-600 dark:border-gray-700 dark:hover:border-transparent">
              ...
              <p className="mt-4 text-gray-500 capitalize dark:text-gray-300 group-hover:text-gray-300">
                The beauty of E-connect is that anyone, anywhere with an
                internet connection can learn from the world’s experts.
              </p>
            </div>
            ...
            <div className="px-12 py-8 transition-colors duration-200 transform border cursor-pointer rounded-xl hover:border-transparent group hover:bg-blue-600 dark:border-gray-700 dark:hover:border-transparent">
              ...
              <p className="mt-4 text-gray-500 capitalize dark:text-gray-300 group-hover:text-gray-300">
                {" "}
                It gives the opportunity to work in a team, which gives a real
                experience of the corporate world. This helps students too
              </p>
            </div>
            ...
            <div className="px-12 py-8 transition-colors duration-200 transform border cursor-pointer rounded-xl hover:border-transparent group hover:bg-blue-600 dark:border-gray-700 dark:hover:border-transparent">
              ...
              <p className="mt-4 text-gray-500 capitalize dark:text-gray-300 group-hover:text-gray-300">
                Being from a non-cs background to a Developer has been a
                tremendous journey and great support by E-connect
              </p>
            </div>
            ...
            <div className="px-12 py-8 transition-colors duration-200 transform border cursor-pointer rounded-xl hover:border-transparent group hover:bg-blue-600 dark:border-gray-700 dark:hover:border-transparent">
              ...
              <p className="mt-4 text-gray-500 capitalize dark:text-gray-300 group-hover:text-gray-300">
                Even though I already had the passion to be a software developer
                all along, it was E-connect who provides me with the right
                framework and support. Due to my training at Masai I was able to
                crack the interview at Smallcase and get the job as Frontend
                Developer.
              </p>
            </div>
          </div>
        ...
        <div className="h-[32rem] bg-gray-100 dark:bg-gray-800">
          <div className="container px-6 py-10 mx-auto">
            ...
            <p className="max-w-2xl mx-auto mt-6 text-center text-gray-500 dark:text-gray-300">
              We are the team of E-connect. We made this project a reality.
            </p>
          </div>
        </div>
          ...
          <div className="grid grid-cols-1 gap-8 mt-8 xl:mt-16 md:grid-cols-2 xl:grid-cols-3">
            <div className="flex flex-col items-center p-4 border sm:p-6 rounded-xl dark:border-gray-700">
              ...
              <div className="flex mt-3 -mx-2">
                ...
                <a
                  href="https://github.com/DeveshGoyal26"
                  className="mx-2 text-gray-600 dark:text-gray-300 hover:text-gray-500 dark:hover:text-gray-300"
                  aria-label="Github"
                >
                  <svg
            ...
            <div className="flex flex-col items-center p-4 border sm:p-6 rounded-xl dark:border-gray-700">
              <img
                className="object-cover w-full rounded-xl aspect-square"
                src="https://media-exp1.licdn.com/dms/image/C4D03AQFCcZjrcCqLWw/profile-displayphoto-shrink_800_800/0/1654363338836?e=1664409600&v=beta&t=WmugH_9IfaGgdyNMHFp3X26QHAmD7XsEJJspzH3-yQs"
                alt=""
              />
              ...
              <div className="flex mt-3 -mx-2">
                ...
                <a
                  href="https://github.com/leadernaga"
                  className="mx-2 text-gray-600 dark:text-gray-300 hover:text-gray-500 dark:hover:text-gray-300"
                  aria-label="Github"
                >
                  <svg
            ...
            <div className="flex flex-col items-center p-4 border sm:p-6 rounded-xl dark:border-gray-700">
              <img
                className="object-cover w-full rounded-xl aspect-square"
                src="https://media-exp1.licdn.com/dms/image/C4D03AQGsVh0dHsu_PA/profile-displayphoto-shrink_800_800/0/1654278816331?e=1664409600&v=beta&t=6UFV4ysUmrScPUdpcNWzjJdqfau0eqXBH4LJoDVDSd8"
                alt=""
              />
              ...
              <div className="flex mt-3 -mx-2">
                ...
                <a
                  href="https://github.com/NirbhayPratapSingh"
                  className="mx-2 text-gray-600 dark:text-gray-300 hover:text-gray-500 dark:hover:text-gray-300"
                  aria-label="Github"
                >
                  <svg
