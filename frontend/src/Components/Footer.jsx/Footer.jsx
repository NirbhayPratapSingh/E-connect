...
const Footer = () => {
  return (
    <div classNameName='dark:border-t border-gray-600 pt-10 p-5'>
        ...
        <div className="container px-6 py-4 mx-auto">
            <div className="lg:flex ">
                <div className="w-1/2 -mx-6 ">
                    <div className="px-6">
                        <div>
                            <a href="#" className="text-xl font-bold text-gray-800 dark:text-white hover:text-gray-700 dark:hover:text-gray-300">E-connect</a>
                        </div>
                ...
                <div className="mt-6 lg:mt-0 lg:flex-1">
                    <div className="flex justify-between gap-6">
                        <div classNameName='w-1/2 '>
                            ...
                            <p className="block mt-2 text-sm text-gray-600 dark:text-gray-400  ">E-connect is a platform where you can learn, meet and share your knowledge anonymously works world wide in all over the world in around 200 countries</p>
                        </div>

                        <div>
                            <h3 className="text-gray-700 uppercase dark:text-white">Contact</h3>
                            <span className="block mt-2 text-sm text-gray-600 dark:text-gray-400 hover:underline">+1 526 654 8965</span>
                            <span className="block mt-2 text-sm text-gray-600 dark:text-gray-400 hover:underline">E-connect@email.com</span>
                        </div>
                    </div>
                </div>
            </div>
