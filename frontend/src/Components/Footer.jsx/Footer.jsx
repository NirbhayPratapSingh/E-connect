...
const Footer = () => {
  return (
    <div className='dark:border-t border-gray-600 pt-10 p-5'>
        ...
        <div class="container px-6 py-4 mx-auto">
            <div class="lg:flex ">
                <div class="w-1/2 -mx-6 ">
                    <div class="px-6">
                        <div>
                            <a href="#" class="text-xl font-bold text-gray-800 dark:text-white hover:text-gray-700 dark:hover:text-gray-300">E-connect</a>
                        </div>
                ...
                <div class="mt-6 lg:mt-0 lg:flex-1">
                    <div class="flex justify-between gap-6">
                        <div className='w-1/2 '>
                            ...
                            <p class="block mt-2 text-sm text-gray-600 dark:text-gray-400  ">E-connect is a platform where you can learn, meet and share your knowledge anonymously works world wide in all over the world in around 200 countries</p>
                        </div>

                        <div>
                            <h3 class="text-gray-700 uppercase dark:text-white">Contact</h3>
                            <span class="block mt-2 text-sm text-gray-600 dark:text-gray-400 hover:underline">+1 526 654 8965</span>
                            <span class="block mt-2 text-sm text-gray-600 dark:text-gray-400 hover:underline">E-connect@email.com</span>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div>
                <p class="text-center text-gray-800 dark:text-white">© Brand 2022 - All rights reserved</p>
            </div>
        </div>
    </footer>
    </div>
